...
def write_regression_csv(out: Path) -> None:
    ...
    rows = [
        ...
        ["REG-CS-02", "1/10", "7/10", "Eq15=221/720; Eq16=-221/720", "source sign inversion"],
        ["REG-PROFIT-01", "1/2", "51/100", "-227/4500", "weak no-switch B-profit gap"],
        ["REG-PROFIT-02", "9/10", "19/20", "41/900", "strong B-profit counterexample"],
        ["REG-HBP-02", "1/2", "1", "unused q_A,p_B invariant", "endpoint price indeterminacy"],
