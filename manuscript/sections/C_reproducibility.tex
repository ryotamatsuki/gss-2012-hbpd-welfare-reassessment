...
\texttt{code/uniform\_game\_cleanroom.py} constructs consumer shares directly from history-specific thresholds and clipping. It separately enumerates feasible unilateral best-response candidates and retains exact rational regressions for the Eq.~(12) counterexample, the equality boundary, consumer-surplus corrections, welfare identities, and the strong-HBP price-selection family.
...
Generative AI assistance was used in parts of literature discovery, verification-code drafting, algebraic cross-checking, and research-workflow organization. AI-generated suggestions were not treated as mathematical evidence: the final equilibrium claims were re-derived from primitives, checked by an independent direct evaluator and exact regressions, and selected proof-critical algebra was separately checked in Lean. The author reviewed all code, claims, citations, and manuscript text and retains full responsibility for the research.
