...
\begin{table}[t]
\centering
\caption{Exact global-deviation counterexample to the unrestricted uniform-price claim}
...
\addplot+[only marks,mark=*,mark size=1.8pt] coordinates {(0.1333978072,0.7166505482)};
\end{axis}
\end{tikzpicture}
