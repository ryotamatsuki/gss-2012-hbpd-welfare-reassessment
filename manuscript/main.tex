...
\input{manuscript/sections/03_uniform_equilibrium}
\input{manuscript/sections/04_hbp_comparisons}
\input{manuscript/sections/05_welfare}
\input{manuscript/sections/06_scope_robustness}
\input{manuscript/sections/07_related_literature}
\input{manuscript/sections/08_discussion}
\input{manuscript/sections/09_conclusion}

\appendix
\input{manuscript/sections/A_uniform_proof}
\input{manuscript/sections/B_surplus_derivations}
\input{manuscript/sections/C_reproducibility}
\input{manuscript/sections/D_declarations}
