...
| CS-2012-1 | accepted-manuscript Eqs. (15)–(16) source-fidelity audit | Eq. (15) source identity, Eq. (16) sign flip, and branch-correct no-switch CS identity | exact algebraic identity lemmas | continuum integration primitives unless separately encoded | prevents source-transcription and branch-domain errors |
